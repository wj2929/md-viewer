...
[![Version](https://img.shields.io/badge/version-1.7.0-green.svg)](https://github.com/wj2929/md-viewer/releases)
...
- 🔍 **强大搜索** - 文件名模糊搜索 + 全文搜索
- 💾 **导出功能** - 导出 HTML / PDF / DOCX（支持所有图表类型）
- 📝 **DOCX 远程服务** - 可配置 Docker 服务，4 种模板样式，25 种图表截图导出 (v1.7.0+)
...
**下载：**
- [最新 macOS 安装包](https://github.com/wj2929/md-viewer/releases/latest) (Apple Silicon / Intel)
...
### Windows
- [最新 Windows 安装包](https://github.com/wj2929/md-viewer/releases/latest)
...
### Linux
- [最新 Linux AppImage](https://github.com/wj2929/md-viewer/releases/latest)

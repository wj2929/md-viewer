...
const MarkdownContent = memo(
  forwardRef<HTMLDivElement, {
    ...
    useEffect(() => {
      ...
      const plantumlBlocks = combinedRef.current.querySelectorAll('pre.language-plantuml')
    ...
    useEffect(() => {
      ...
      combinedRef.current.addEventListener('click', handlePlantUMLClick)
      return () => combinedRef.current?.removeEventListener('click', handlePlantUMLClick)
    }, [html])
